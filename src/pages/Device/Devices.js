    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView
          refreshControl={
            <RefreshControl
              refreshing={this.props.device.loading}
              onRefresh={this.onRefreshHandler.bind(this)}
            />
          }
        >
          <View style={styles.list}>{this.devices()}</View>
        </ScrollView>
        <ActionButton buttonColor="rgba(231,76,60,1)">
          <ActionButton.Item
            buttonColor="#1abc9c"
            title="Refresh"
            onPress={this.onRefreshClickHandler.bind(this)}
          >
...
const connectedDevicesPage = connect(
  mapStateToProps,
  mapDispatchToProps,
)(Devices)
